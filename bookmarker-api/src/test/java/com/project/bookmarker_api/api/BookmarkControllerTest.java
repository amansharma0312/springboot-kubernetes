package com.project.bookmarker_api.api;

import com.project.bookmarker_api.domain.Bookmark;
import com.project.bookmarker_api.domain.BookmarkRepository;
...
@TestPropertySource(properties = {
        "spring.datasource.url=jdbc:tc:postgresql:14-alpine:///bookmark"
})
class BookmarkControllerTest {
    ...
    @ParameterizedTest
    @CsvSource({
            "1,15,8,1,true,false,true,false",
            "2,15,8,2,false,false,true,true"
    })
